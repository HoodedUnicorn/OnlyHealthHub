    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  viewPager.setAdapter(pagerAdapter);
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_calendar, R.id.nav_login, R.id.nav_register, R.id.nav_patient_records, R.id.nav_patient_records, R.id.nav_medication, R.id.nav_notifications)
